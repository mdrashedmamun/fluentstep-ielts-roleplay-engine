...
,
    ...
    // ===== NEW: COMMUNITY CATEGORY =====
    {
        ...
        dialogue: [
            ...
            { speaker: 'You', text: 'First, ________ would fundamentally alter our neighbourhood character.' },
            { speaker: 'You', text: 'Second, the ________ impact is unacceptable.' },
            { speaker: 'Councillor Ahmed', text: 'I see your ________ . Could you elaborate on the traffic concern?' },
            { speaker: 'You', text: 'The development will ________ traffic by an estimated 40%.' },
            { speaker: 'You', text: 'Our roads simply can\'t ________ this volume.' },
            { speaker: 'Councillor Ahmed', text: 'That\'s a fair ________ . Have you spoken with the developers?' },
            { speaker: 'You', text: 'We have, but they\'re not ________ to compromise on scale.' },
            { speaker: 'You', text: 'We\'d be grateful if the council would ________ the proposal.' },
            { speaker: 'Councillor Ahmed', text: 'Your ________ is noted for the official record.' },
            { speaker: 'Councillor Ahmed', text: 'We\'ll ________ all viewpoints before making a decision.' }
        ],
        answerVariations: [
    ...
    // ===== NEW: WORKPLACE (ELEVATED) CATEGORY =====
    {
        ...
        dialogue: [
            ...
            { speaker: 'Margaret', text: 'Delegation. You tend to ________ too much responsibility rather than supporting your team.' },
            { speaker: 'Margaret', text: 'Actually, let me rephrase - you need to ________ your team more effectively.' },
            { speaker: 'You', text: 'That\'s ________ feedback. I\'ll be more careful about that.' },
            { speaker: 'You', text: 'I\'ll also endeavour to be more conscious of ________ junior colleagues.' },
            ...
            { speaker: 'Margaret', text: 'We\'d be delighted to ________ that progression.' },
            { speaker: 'Margaret', text: 'I\'ll ________ some management training for you.' }
        ],
        answerVariations: [
