...
BATCH_SCENARIOS = ['advanced-1-manager-escalation', 'advanced-2-manager-no', 'advanced-2-moving-house', 'advanced-3-manager-pushback', 'advanced-4-honesty-tact']
