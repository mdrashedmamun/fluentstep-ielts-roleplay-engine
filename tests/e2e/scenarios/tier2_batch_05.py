...
BATCH_SCENARIOS = ['service-33-hotel-checkin', 'service-34-shopping-return', 'service-4-return-no-receipt', 'service-5-security', 'service-8-restaurant-order']
