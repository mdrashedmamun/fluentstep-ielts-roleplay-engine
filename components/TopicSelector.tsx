        ...
        <div className="pt-4">
          <div className="inline-flex items-center gap-4 px-6 py-3 bg-white border border-emerald-100 rounded-2xl shadow-sm">
            <div className="flex flex-col items-start">
              <span className="text-[10px] font-black uppercase tracking-tighter text-emerald-800/40">Daily Capacity <span className="ml-1 text-[8px] opacity-30 italic">v2.0-LOGIC</span></span>
