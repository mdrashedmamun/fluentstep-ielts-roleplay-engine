...
export const CURATED_ROLEPLAYS: RoleplayScript[] = [
    ...
    },
    {
        ...
        answerVariations: [
            { index: 1, answer: 'mental', alternatives: ['mad', 'hectic', 'intense'] },
            { index: 2, answer: 'chaotic', alternatives: ['mad', 'insane', 'crazy'] },
            { index: 3, answer: 'late', alternatives: ['delayed'] },
...
,
    ...
    },
    {
        ...
        characters: [
            { name: 'Landlord', description: 'Property owner, professional but sometimes resistant.' },
            { name: 'You', description: 'Tenant, firm but polite.' }
        ],
        dialogue: [
            { speaker: 'Landlord', text: 'Hello? Who\'s calling?' },
            { speaker: 'You', text: 'Hi, it\'s ________ from [property address]. I\'m sorry to ________ you, but I have some concerns about the property that I wanted to discuss.' },
            { speaker: 'Landlord', text: 'Oh, hello. What seems to be the ________?' },
            { speaker: 'You', text: 'Well, there are actually a ________ of issues that have come up recently. The most urgent is that there\'s water ________ from the ceiling in the bedroom. It appears to have been going on for a while.' },
            { speaker: 'Landlord', text: 'A water leak? That\'s not good. How ________ is it?' },
            { speaker: 'You', text: 'It\'s fairly ________. The ceiling is starting to show ________, and I\'m concerned about potential ________ damage.' },
            { speaker: 'Landlord', text: 'I see. What else?' },
            { speaker: 'You', text: 'Additionally, the heating system isn\'t working ________, so it\'s quite cold in the flat. And the bathroom window has a ________ in it, which is affecting my ________.' },
            { speaker: 'Landlord', text: 'A crack in the window? That\'s ________ to deal with. Look, these things take ________.' },
            { speaker: 'You', text: 'I appreciate that, but as you know, you\'re ________ to ensure the property is in a ________ condition. The water leak is a health and safety ________.' },
            { speaker: 'Landlord', text: 'Yes, yes, I understand. But I need to ________ contractors. These things don\'t happen ________.' },
            { speaker: 'You', text: 'I completely ________ that, but I\'d like to propose a ________ for getting these fixed. Could we arrange for someone to look at the water leak within the next ________ days?' },
            { speaker: 'Landlord', text: 'That might be difficult. These things are ________. I\'ll need to ________ my handyman and see when he\'s ________.' },
            { speaker: 'You', text: 'I\'d really ________ it if you could prioritize this. It\'s affecting my ________ to enjoy the property. Would ________ days be more realistic?' },
            { speaker: 'Landlord', text: 'Let me ________ into it and get back to you. I can probably arrange something in ________ weeks.' },
            { speaker: 'You', text: 'That\'s a bit longer than I was ________, but I appreciate your ________ to resolve this. Could you at least confirm by ________ of this week?' },
            { speaker: 'Landlord', text: 'Yes, I can ________ that. I\'ll speak to my contractor and confirm by Friday.' },
            { speaker: 'You', text: 'Thank you. And regarding the other ________, the heating and the window—can we ________ a timeline for those as well?' },
            { speaker: 'Landlord', text: 'I\'ll look into those too. The window is probably ________ urgent than the heating, but I\'ll get back to you with a complete ________ of repairs needed.' },
            { speaker: 'You', text: 'I\'d be ________ if you could send me a ________ email with the proposed timeline for all three ________.' },
            { speaker: 'Landlord', text: 'Of course. I\'ll do that by ________ of the week.' },
            { speaker: 'You', text: 'Perfect. Thank you for being so ________ about this.' }
        ],
        answerVariations: [
            { index: 1, answer: 'name', alternatives: ['Sarah', 'John', 'introduction'] },
            { index: 2, answer: 'bother', alternatives: ['trouble', 'disturb', 'interrupt'] },
            { index: 3, answer: 'problem', alternatives: ['issue', 'matter', 'concern'] },
            { index: 4, answer: 'couple', alternatives: ['number', 'few', 'several'] },
            { index: 5, answer: 'leaking', alternatives: ['dripping', 'coming', 'flowing'] },
            { index: 6, answer: 'bad', alternatives: ['serious', 'urgent', 'critical'] },
            { index: 7, answer: 'serious', alternatives: ['urgent', 'critical', 'concerning'] },
            { index: 8, answer: 'damage', alternatives: ['marks', 'stains', 'discoloration'] },
            { index: 9, answer: 'water', alternatives: ['structural', 'mold', 'mould'] },
            { index: 10, answer: 'properly', alternatives: ['correctly', 'well', 'as it should'] },
            { index: 11, answer: 'crack', alternatives: ['fracture', 'break', 'split'] },
            { index: 12, answer: 'privacy', alternatives: ['comfort', 'security', 'well-being'] },
            { index: 13, answer: 'difficult', alternatives: ['challenging', 'complicated', 'tricky'] },
            { index: 14, answer: 'time', alternatives: ['patience', 'effort', 'coordination'] },
            { index: 15, answer: 'legally obligated', alternatives: ['responsible', 'required', 'obligated'] },
            { index: 16, answer: 'habitable', alternatives: ['good', 'safe', 'proper'] },
            { index: 17, answer: 'issue', alternatives: ['concern', 'problem', 'hazard'] },
            { index: 18, answer: 'contact', alternatives: ['call', 'arrange', 'find'] },
            { index: 19, answer: 'overnight', alternatives: ['instantly', 'quickly', 'at once'] },
            { index: 20, answer: 'understand', alternatives: ['appreciate', 'get', 'recognize'] },
            { index: 21, answer: 'timeline', alternatives: ['schedule', 'plan', 'timetable'] },
            { index: 22, answer: '7', alternatives: ['seven', '10', '14'] },
            { index: 23, answer: 'complicated', alternatives: ['complex', 'intricate', 'tricky'] },
            { index: 24, answer: 'contact', alternatives: ['speak to', 'call', 'ring'] },
            { index: 25, answer: 'available', alternatives: ['free', 'around', 'accessible'] },
            { index: 26, answer: 'appreciate', alternatives: ['value', 'prefer', 'need'] },
            { index: 27, answer: 'ability', alternatives: ['capacity', 'opportunity', 'chance'] },
            { index: 28, answer: '10', alternatives: ['14', 'two weeks', '21'] },
            { index: 29, answer: 'look into', alternatives: ['check', 'investigate', 'explore'] },
            { index: 30, answer: '2-3', alternatives: ['one', 'two', 'three'] },
            { index: 31, answer: 'hoping', alternatives: ['expecting', 'anticipating', 'wanting'] },
            { index: 32, answer: 'commitment', alternatives: ['willingness', 'effort', 'cooperation'] },
            { index: 33, answer: 'end', alternatives: ['close', 'finish', 'weekend'] },
            { index: 34, answer: 'confirm', alternatives: ['promise', 'guarantee', 'assure'] },
            { index: 35, answer: 'issues', alternatives: ['matters', 'things', 'concerns'] },
            { index: 36, answer: 'establish', alternatives: ['set', 'arrange', 'agree on'] },
            { index: 37, answer: 'less', alternatives: ['not as', 'fewer', 'lower'] },
            { index: 38, answer: 'assessment', alternatives: ['list', 'schedule', 'inventory'] },
            { index: 39, answer: 'grateful', alternatives: ['delighted', 'appreciative', 'pleased'] },
            { index: 40, answer: 'written', alternatives: ['formal', 'detailed', 'summary'] },
            { index: 41, answer: 'issues', alternatives: ['problems', 'matters', 'concerns'] },
            { index: 42, answer: 'end', alternatives: ['close', 'finish', 'weekend'] },
            { index: 43, answer: 'understanding', alternatives: ['cooperative', 'helpful', 'receptive'] }
        ],
        deepDive: [
            { index: 15, phrase: 'legally obligated', insight: 'Formal term used in landlord-tenant disputes. Signals knowledge of rights and responsibilities. Shows confident, assertive communication at B2-C1 level.' },
            { index: 16, phrase: 'habitable condition', insight: 'Legal/formal property terminology. More sophisticated than "good condition". Shows tenant awareness of legal standards and rights.' },
            { index: 17, phrase: 'health and safety issue', insight: 'Bureaucratic phrasing that carries weight in property disputes. Signals seriousness and potential legal implications. Shows strategic communication.' },
